  ...
  const socials = [
    {
      ...
      socialMedia: github,
      socialMediaLink:
        "https://github.com/Excel-001?tab=overview&from=2024-03-01&to=2024-03-31",
    },
    {
      socialMediaName: "Instagram",
      socialMedia: instagram,
      socialMediaLink: "https://www.instagram.com/excel_00100/?hl=en",
    },
    {
      socialMediaName: "Linkedin",
      socialMedia: linkedin,
      socialMediaLink: "https://www.linkedin.com/in/kelechi-chukwu-086420249/",
    },
    {
      socialMediaName: "Figma",
      socialMedia: figma,
      socialMediaLink:
        "https://www.figma.com/files/drafts?fuid=1227526873109683985",
    },
  ];
  const navs = [
    ...
    <>
      <section
        ...
        className={` lg:h-[99vh] h-fit flex flex-col justify-between items-center ${
          darkMode
            ? "light-mode text-[#555555] b bg-gradient-to-br from-55% from-[#CDC9C3] to-[#a5a5a5] via-[#f2f2f2] to-[#666666] to-[#CDC9C3] "
            : "dark-mode text-[#fff] bg-gradient-to-br from-40% from-[#120720] to-black via-purple-600 to-[#F237F6C2] to-purple-900 "
        }`}
      >
        <div className="flex items-center justify-center w-11/12   mt-6  ">
          <motion.nav
            ...
            className={`shadow-inset lg:border  text-start  h-fit grid grid-cols-3  w-11/12  p-6  md:gap-7 lg:fixed  top-0 z-40 mt-1 pt-3  backdrop-blur-[192px]  rounded-[1.125rem]   lg:flex lg:text-center  ${
              darkMode ? "bg-[#555555] border-[#555555]   text-[#CDC9C3]" : "border-[#c213ff] "
            }`}
          >
            <p className="font-[K2D] font-extrabold col-span-2 lg:col-span-1 text-start   b w-full   text-[1.6rem]   lg:text-[2.5rem]">
              Excel
            </p>
            <div className=" grid justify-end lg:hidden col-span-1">
              <button
            ...
            <div
              className={`lg:rounded lg:col-span-8 backdrop-blur-lg bg-inherit duration-700 transition w-full lg:flex    py-9 lg:py-0  flex-col  lg:flex-row md:b justify-start items-center gap-10   ${
                darkMode ? "bg-[#595959]" : "bg-[#120720]"
              } ${!toggleMenu ? "hidden" : "flex"}
           
                 `}
            >
              <ul className="font-inter    w-full font-medium flex flex-col lg:flex-row gap-10 ">
                {navs.map((nav) => (
                  <motion.li
                    key={nav.id}
                    initial={{ opacity: 0 }}
                    ...
                    className={`group backdrop-blur-lg w-fit bg-inherit  ${
                  ...
                  >
                    ...
                    >
                      {nav.content}
                      <div
                        className={` h-1 bottom-0 left-0 right-0  rounded-full   transform scale-x-0 origin-left transition-transform duration-200 ease-in-out ${
                          activeNavItem === nav.href
              ...
              <div className="  w-full  flex flex-col lg:flex-row lg:items-center gap-10 lg:gap-0  ">
                <label class="inline-flex  w-fit items-center me-5 cursor-pointer gap-3  ">
                  ...
                  <span class=" text-sm font-medium font-[inter] t">
                    DARK
                  </span>
                  <motion.div
                ...
                <span>
                  <a href="#contact">
                    <motion.button
                      whileTap={{ scale: 0.75 }}
                      type="button"
                      className={`opacity-50 hover:opacity-100 text-center p-3 hover:ease-in focus:bg-opacity-100 font-bold not-italic font-[inter] lg:w-[10.4rem]  w-[10rem] rounded-[3.125rem] ${ darkMode ? " bg-[#CDC9C3] text-[#120720]" : "bg-[#EB03FF]"}`}
        ...
        <div className="  w-11/12 lg:relative">
          <div className="flex  flex-col lg:flex-row lg:justify-between relative  items-end gap-16   lg:items-end">
            <div className="flex gap-6  font-[inter] flex-col sm:pt-11 lg:p-0  font-normal text-[1.6rem] lg:w-[20rem] lg:h-[70vh]  ">
              <p
                className={` font-[K2D] lg:w-[34.5rem] w-fit  lg:h-[20rem]  font-extrabold  lg:text-[7.0rem]  lg:oh-3/6 text-[3.2rem] ${
                  darkMode ? "light-mode text-[#555555]" : "dark-mode text-white"
                }`}
              >
                <TypeAnimation
            ...
            <div className="lg:h-[70vh]  absolute lg:relative bottom-0 w-11/12  flex lg:flex-col h-fit    lg:gap-16  lg:w-fit lg:gap-6">
              {socials.map((social, index) => (
                <a
                  className="  w-fit grid items-center relative grid-cols-3 group"
                ...
                >
                  <motion.img
                    ...
                    src={social.socialMedia}
                    alt=""
                  />
                  <p className="  col-span-2 text-base  group-hover:block transition-all duration-200 hidden   ease-in  h-fit">
      ...
      <div className={` ${darkMode ? "bg-[#CDC9C3] text-[#555555]" : "bg-[#120720] text-white"}`}>
        <section
          id="about"
            ...
            <section className="md:hidden ">
              ...
              <span>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div  className={`rounded-e-2xl h-full w-[50%] ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                </div>
              </span>
              <span>
                <p>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div className={`h-full w-[65%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`} ></div>
                </div>
              </span>{" "}
              <span>
                <p>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div className={` h-full w-[75%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                </div>
              </span>
              <span>
                <p>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div  className={` h-full w-[79%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                </div>
              </span>{" "}
              <span>
                <p>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div  className={` h-full w-[80%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                </div>
              </span>{" "}
              <span>
                <p>
              ...
              <span>
                ...
                <span>
                  ...
                  <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                    <div  className={` h-full w-[90%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                  </div>
                </span>
                <p>
                  html <i>{html}%</i>
                ...
                <div className=" h-3 rounded-2xl bg-slate-600  w-full">
                  <div className={` h-full w-[95%]  rounded-e-2xl ${ darkMode ? 'bg-[#555555]':'bg-[#9733ee]'}`}></div>
                </div>
              </span>
            </section>
            ...
            <section className="hidden  md:grid grid-cols-9">
              <section className=" grid lg:col-span-3 col-span-3  grid-rows-3 justify-center ">
                <div className=" bg-transparent row-span-1 py-8 w-full h-fit">
                  <div className={`items-center  justify-between  px-10   shadow-lg rounded-2xl h-20 flex ${darkMode ? 'bg-[#555555]  text-[#CDC9C3]':' bg-[#2d1a45]'}`}>
              ...
              <motion.section
                animate={{ rotate: 360 }}
                className={`border rounded-full border-dashed flex m-auto p-10  justify-center col-span-3   ${darkMode ? 'border-[#555555]':'border-[#9733ee]'}`}
              ...
              >
                <defs>
                  <linearGradient id="GradientColor">
                    <stop offset="0%"  stop-color={`${darkMode ? '#120720':'#da22ff'}`} />
                    <stop offset="100%"  stop-color={`${darkMode ? '#555555':'#9733ee'}`} />
                  </linearGradient>
                </defs>
                <circle
                  className="circle2"
              ...
              <section className=" grid  lg:col-span-3 col-span-3  grid-rows-3 justify-center ">
                <div className=" bg-transparent row-span-1 py-8 w-full h-fit">
                  <div
                  className={`items-center  justify-between  px-10  shadow-lg    rounded-2xl h-20 flex ${darkMode ? 'bg-[#555555]  text-[#CDC9C3]':' bg-[#2d1a45]'}`}
          ...
          <ol class="items-center z-10 backdrop-blur-[6rem]   p-5    sm:flex flex-wrap">
            <li class="relative flex lg:flex-col gap-3  mb-6 sm:mb-0  lg:h-[13rem] sm:w-3/6 lg:w-3/12">
              ...
              <div class="mt-3 sm:pe-8">
                ...
                <p className={`text-base font-normal ${darkMode ? "" : "text-gray-500"}`}>
        ...
        <section
          id="contact"
          className={` h-fit -[#120720]   gap-[6rem] ${darkMode ? "":"bg-[image:var(--image-url)] bg-no-repeat"} `}
        ...
        >
          ...
          {showAlert && (
            <motion.div
              ...
              className="bg-[#49212161]  -[#49212161] text-[1.2rem] text-center rounded-lg  px-4 py-3  w-11/12 md:w-6/12 h-full m-auto  relative mb-4"
              role="alert"
            >
              ...
              <p>
                Hey {senderName}, your email has been sent. Excel will get back
                to you soon
              </p>
              <svg
