...
function App() {
  ...
  const text =
    ...
    const fetchData = async () => {
      try {
        ...
        setData(jsonData);
        setProjectCount(jsonData.length);
      } catch (error) {
  ...
  return (
    <div className=" scroll-smooth">
      <section
        id="home"
        className={`h-dvh md:h-fit flex flex-col justify-between items-center ${
          darkMode
      ...
      >
        ...
        <div className="  w-11/12  lg:relative">
          <div className="flex  flex-col lg:flex-row lg:justify-between relative  items-end gap-16   lg:items-end">
            <div className="border col-span-full">
    
            </div>
            <div className="flex gap-6   font-[inter] order-1 flex-col sm:pt-11 lg:p-0  font-normal text-[1.6rem] lg:w-[20rem] lg:h-[70vh]  ">
              <p
            ...
            <div className="lg:flex w-[100%] hidden -order-1 lg:order-2   lg:w-6/12 justify-center items-center ">
              <Globe darkMode={darkMode} />
            </div>
            <div className="lg:h-fit lg:self-center  order-3   lg:relative bottom-0 w-11/12  flex lg:flex-col h-fit    lg:gap-16  lg:w-fit ">
      ...
      >
        <section
          id="about"
          className={` lg:flex w-11/12 m-auto sm:gap-12 lg:flex-col md:h-svh h-fit relative  py-5 items-center `}
        >
              ...
              <span className=" flex justify-between  relative items-center lg:items-end">
                <a href="#contact" className=" m-auto md:m-0">
                  <motion.button
                    whileTap={{ scale: 0.75 }}
                    type="button"
                    className={`opacity-50 mt-3 md:mt-0 hover:opacity-100 text-center p-3 hover:ease-in focus:bg-opacity-100 font-bold not-italic font-[inter] lg:w-[10.4rem]  w-[10rem] rounded-[3.125rem] ${
          ...
          <div className="w-11/12 flex flex-col gap-12 my-[5vh]">
            ...
            <section className="md:hidden ">
              <span>
                ...
                <div className=" h-1 rounded-2xl bg-slate-600  w-full">
                  <div
